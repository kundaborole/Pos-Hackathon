...
export default function ReportsClient({ metrics }: { metrics: DashboardMetrics }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="border border-border-warm shadow-sm">
          <CardContent className="p-6">
            ...
            <div className="text-3xl font-black text-primary-forest">₹{metrics.kpis.revenue.toFixed(2)}</div>
          </CardContent>
        </Card>
        <Card className="border border-border-warm shadow-sm">
          <CardContent className="p-6">
            <div className="text-sm font-medium text-text-secondary mb-1">Total Orders</div>
            <div className="text-3xl font-black text-text-primary">{metrics.kpis.orders}</div>
          </CardContent>
        </Card>
        <Card className="border border-border-warm shadow-sm">
          <CardContent className="p-6">
            <div className="text-sm font-medium text-text-secondary mb-1">Average Order Value</div>
            <div className="text-3xl font-black text-text-primary">₹{metrics.kpis.avgTicket.toFixed(2)}</div>
          </CardContent>
        </Card>
        <Card className="border border-border-warm shadow-sm">
          <CardContent className="p-6">
            <div className="text-sm font-medium text-text-secondary mb-1">Completed Orders</div>
            <div className="text-3xl font-black text-text-primary">{metrics.kitchenPulse.completedToday}</div>
          </CardContent>
        </Card>
      </div>
